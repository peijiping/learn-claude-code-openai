...
#把上面的三行英文帮我翻译成中文
1. 重写文件 hello.py: 添加类型提示、文档字符串和主守卫
2. 创建 Python 包，包含 __init__.py、utils.py 和 tests/test_utils.py
3. 审查所有 Python 文件，修复任何样式问题

创建 Python 包 test，写文件 hello.py: 添加类型提示、文档字符串和主守卫。其他文件还包含 __init__.py、utils.py 和 test_utils.py。审查所有 Python 文件，修复任何样式问题。